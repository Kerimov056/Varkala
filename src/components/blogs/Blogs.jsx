...
//     return (
//         <>
//             <div id='ResB' className='blog' style={useContext(TemaColor)}>
//                 <div>
//                     <div>
//                         <h1>Blog</h1>
...
//             <div id='ResBlog' style={useContext(TemaColor)}>
//                 <div>
...
//             <div className='carts' style={useContext(TemaColor)}>
...
//                 </div>
//             </div>
//             <div className='low' style={useContext(TemaColor)}>
